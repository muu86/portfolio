...
export function Hero() {
  return (
    <>
          ...
          <main className="relative px-4 sm:px-8 lg:px-12">
            <div className="mx-auto max-w-2xl lg:max-w-5xl">
              <div className="max-w-2xl mx-auto">
                <div className="outline-1 h-16 aspect-square -scale-x-100 flex justify-center items-center rounded-full overflow-hidden">
                  <Image
                    className="shadow-xl"
                    src={ProfileImage}
                ...
                <div>
                  <Block className="font-semibold text-4xl font-mono">
                    {/*<Line*/}
                    ...
                    <Line
                      className="text-2xl"
                      tokens={[<Comment key={id()}>println(&ldquo;안녕하세요!&rdquo;)</Comment>]}
                    />
                    <Line
                      tokens={[
                        <Keyword name="val" key={id()} />,
                        <Variable name="iam" key={id()} />,
                        <Assignment key={id()} />,
                        <Keyword name="Developer" key={id()} />,
                        <Brace type="(" key={id()} />,
                      ]}
                    />
                    <Block level={1}>
                      <Line
                        className="mt-4"
                        tokens={[
                          <Variable name="name" className="text-fuchsia-600" key={id()} />,
                          <Assignment key={id()} />,
                      ...
                      <Line
                        ...
                        tokens={[
                          <Variable name="note" className="text-fuchsia-600" key={id()} />,
                          <Assignment key={id()} />,
                          <String className="text-5xl" key={id()}>
                            엠제이라고 합니다.
                          </String>,
      ...
      <section className="w-full max-w-7xl mx-auto px-8"></section>
    </>
  );
}
