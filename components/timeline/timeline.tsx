...
import type { TimelineColor } from "@/data/history"
...
const TimelineItem = React.forwardRef<HTMLLIElement, TimelineItemProps>(
  (
    ...
    const content = (
      ...
      >
        {/* Date */}
        <div className="flex flex-col justify-start pt-1  col-span-2">
        ...
        <div className="flex flex-col items-center h-full">
          ...
          <Separator orientation="vertical" className="border h-full" />
        </div>

        {/* Content */}
        <TimelineContent className="col-span-8">
          <TimelineHeader className="my-2">
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "max-w-sm text-sm text-muted-foreground prose dark:prose-invert",
      className,
    )}
    {...props}
  />
