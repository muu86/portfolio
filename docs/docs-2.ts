...
타 기업과의 협업을 진행하면서, 기존 시스템의 백엔드를 새로 구축해야 하는 부담이 있었으나,
장기적인 서비스 안정성과 확장성을 고려했을 때, 초기 단계에서 체계를 확립하는 것이 중요하다고 판단했습니다. 전환은
팀원들의 동의를 얻은 후 시작되었으며, 기존 프로젝트와 NestJS 전환 작업을 병행하며 진행했습니다.
...
프로젝트였기 때문에 제 기여도는 크지 않습니다. 이 프로젝트를 통해 회사에서 사용되는 DB 프로시저를 파악하고
**커머스 전반에 걸친 프로세스**를 학습할 수 있었습니다.

기술적인 관점뿐만 아니라 회사의 전반적인 운영 흐름에 대한 중요한 이해를 얻을 수 있었습니다.`,
  },
...
위메프와 홈앤쇼핑(Home&Shopping) 간의 상품 및 주문 연동 프로젝트에 참여하여, 상품 연동 작업을 담당했습니다.

- **API 연동**: 제공된 API 명세에 따라 REST API를 사용하여 상품 데이터를 연동
- **자동화된 데이터 업데이트**: **Spring Scheduler**를 활용해 주기적인 데이터베이스 업데이트
...
- 아쉽게도 갓 입사한 저에게 핵심 업무는 주어지지 않았습니다. 대신, 유저에게 건강 설문을 시행하고, 설문 결과에 따라 맞춤형
